...
if(!class_exists('JeffreyBostoenExtensions\Framework\CMDBChangeHelper')) {
...
if(!class_exists('jb_itop_extensions\components\CMDBChangeHelper')) {
	class_alias(CMDBChangeHelper::class, 'jb_itop_extensions\components\CMDBChangeHelper');
}
